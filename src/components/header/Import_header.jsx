...
function Import_header(props) {
    return (<div className={css(styles.container)}>
        <div className={css(styles.buttons_container)}>
            ...
            <BaseButton text='返回' type='gray' classes={styles.right} onClick={props.onBack} />
        </div>
        <div className={css(styles.buttons_container)}>
            {getHeaderType(props.state) !== 'processing' &&
                <div className={css(styles.buttons_subgroup)}>
                    <BaseButton text='导入本地文件' type='green' classes={styles.button_flex} onClick={props.onSelect} />
            ...
            {getHeaderType(props.state) === 'processing' &&
                <BaseButton text='关闭导入' type='green' classes={styles.button_flex} onClick={props.onCancel} />
            }
        </div>
